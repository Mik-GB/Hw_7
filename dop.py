...
quant_line = int(input("Введите количество строк: "))
quant_columns = int(input("Введите количество столбцов: "))
print_operation_table(lambda x, y: x * y, quant_columns, quant_line)